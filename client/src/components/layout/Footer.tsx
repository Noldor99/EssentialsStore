    ...
    <footer className="bg-foreground py-20">
      <section className="container">
        <div className="flex flex-col">
          <h3 className="text-h2 mb-8 w-full border-b-2 border-l border-black pb-6 pl-8 text-left">
            Contact
          </h3>
          <div className="flex w-full flex-wrap items-start justify-between gap-2">
            <div className="flex w-full flex-col items-start justify-start md:w-1/2">
              <h3 className="text-m md:text-h3 mb-6">Privacy is our paramount</h3>
              {links.map(({ label, url, urlLabel }, index) => (
                <div
                  ...
                  key={index}
                >
                  <p className="w-full max-w-[280px] whitespace-nowrap text-left">{label}</p>
                  <a
                    className="text-s w-full max-w-[280px] text-left underline underline-offset-2"
                    href={url}
                  >
                    {urlLabel}
                  </a>
            ...
            <div className="mt-6 flex items-start justify-end gap-4 md:mt-0">
              <Button className="bg-white p-2" variant={'outline'}>
                <IconBrandTelegram />
              </Button>
              <Button className="bg-white p-2" variant={'outline'}>
                <IconBrandDiscord />
